                ...
                <ul>
                    ...
                    <img src="images/banner/banner_2.jpg" alt="Sky" class="rev-slidebg"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption font-lora sfb tp-resizeme letter-space-5 h-p"
                            ...
                            style="z-index: 7; color:#fff; font-family:'Rubik', sans-serif; max-width: auto; max-height: auto; white-space: nowrap; font-weight:500;">Təhsilin məqsədi Biliyin İnkişafıdır
                        </div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption NotGeneric-Title   tp-resizeme"
                            ...
                            style="z-index: 5; font-family:'Roboto', sans-serif; font-weight: 700; white-space: nowrap;text-transform:left;">Daha Yaxşı Təhsil Alın
                        </div>
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme"
                            ...
                            style="z-index: 5; font-family:'Roboto', sans-serif; font-weight: 700; white-space: nowrap;text-transform:left;">Education Center
                        </div>
                        ...
                        style="z-index: 14; white-space: nowrap;  font-weight:500; color:#ffffff; font-family:Rubik; text-transform:uppercase; background-color:#092ace; letter-spacing:1px; border-radius: 3px;"><a class="text-white" href={{ route('apply') }}>Müraciət et</a>
                        </div>
                    </li>
