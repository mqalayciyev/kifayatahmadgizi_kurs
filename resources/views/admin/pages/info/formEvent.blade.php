...
@section('content')
 ...
 <section class="content">
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.events.save', @$entry->id) }}" method="POST">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header text-right">
                            @if($entry->id>0)
                                <a href={{ route('admin.events.new') }} class="btn btn-success" href><i class="fas fa-plus"></i> Yeni</a>
                                <button type="submit" class="btn btn-info"><i class="fas fa-sync-alt"></i> Yenilə</button>
                            @else
                                <a href="{{ route('admin.events') }}" class="btn btn-default">Ləğv et</a>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 ">
                                            <div class="row">
                                                ...
                                                <a href="{{ route('admin.events.delete_image' , [old('id', $entry['id']), old('id', $image['id'])]) }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>

                                            </div>
                                        </div>
                                        <div class="col-12 p-2">
                                            
                                                <img id="event_image" class="w-100" style="max-width: 600px;" src="{{ asset('images/events/' . old('image', $image['image'])) }}" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="address" id="address" class="form-control" value="{{ old('address', $entry['address']) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="row form-group">
                                        <label for="start" class="col-sm-3 col-form-label">Başlama</label>
                                        <div class="col-sm-9">
                                            <input type="datetime-local" name="start" id="start" class="form-control" value="{{ old('start', $entry['start']) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="row form-group">
                                        <label for="end" class="col-sm-3 col-form-label">Bitmə</label>
                                        <div class="col-sm-9">
                                            <input type="datetime-local" name="end" id="end" class="form-control" value="{{ old('end', $entry['end']) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $(function () {
        ...
        $('.crop_image').click(function(event){
            ...
            image_crop.croppie('result', {type: 'blob', format: 'jpg', size : {width: 450, height : 350}, quality: 1,}).then(function(blob) {
                ...
                if(url){
                     ajaxFormPost(formData, "{{ route('admin.events.upload_image') }}");
                }
                else{
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response['status'] === 'success') {
                        ...
                        $('#cover_image').val("");
                        $('#event_image').attr('src', response['url']);
